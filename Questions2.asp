...
<HTML>
	...
	<BODY style="background-color: 50B2DF;"> 
		...
		<H2>Practice 2: Questions with basic multiplication and division.</H2>
		<br>
				...
				<ul>
					<%
						...
						strConnection = "DRIVER=Microsoft Access Driver (*.mdb);DBQ=" & _
						   Server.MapPath("data\Questions2.mdb")
												
						objConn.Open (strConnection)
						Dim objRS
						Set objRS = Server.CreateObject("ADODB.Recordset")
						objRS.Open "Questions2", objConn ,,, 2
