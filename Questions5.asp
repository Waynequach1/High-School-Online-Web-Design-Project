...
<HTML>
	...
	<BODY style="background-color: 50B2DF;"> 
		...
		<H2>Practice 1: Questions with mixed operators, exponents and brackets.</H2>
		<br>
				...
				<ul>
					<%
						...
						strConnection = "DRIVER=Microsoft Access Driver (*.mdb);DBQ=" & _
						   Server.MapPath("data\Questions5.mdb")
												
						objConn.Open (strConnection)
						Dim objRS
						Set objRS = Server.CreateObject("ADODB.Recordset")
						objRS.Open "Questions5", objConn ,,, 2
					...
					<%
						...
						For X = 1 to 10
							...
							if x < 10 then
								do while len(Sentence2) < (92 - len(Sentence1)) * 6
									Sentence2 = Sentence2 & "&nbsp;"
								loop
							else
